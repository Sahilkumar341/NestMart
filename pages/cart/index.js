    ...
    const deleteItem = async (id) => {
        ...
        try {
            ...
            if (response.status === 200) {
                // If the delete request was successful, update the cart data and remove the item from the context
                await getCartData("http://localhost:5000/cartItems");
                await context.removeItemsFromCart(id);
            } else {
                        ...
                        <div className='col-md-8'>
                            <div className='d-flex align-items-center w-100'>
                                <div className='left'>
                                    ...
                                    <p><span className='text-g'></span> products in your cart</p>
                                </div>
